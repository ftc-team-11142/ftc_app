...
//        pipeline = new ColorPipeline(260,290,600,359, "close blue");
//
...
//                    drivetrain.autoMove(23, -44.75, 270, 0.5, 0.5, 2, odometryPose, telemetry);
//                    if (drivetrain.hasReached()) {
//                        main_id += 1;
//                    }
//                    break;
//                case 4:
//                    if (game_timer.seconds() > 27) {
...
//                case 4:
////                    lift.setTrayPosition(0.2);
//                    drivetrain.autoMove(16.5, -44.29, 270, 0.5, 0.5, 2, odometryPose, telemetry);
//                    if (drivetrain.hasReached()) {
//                        main_id += 1;
//                    }
//                    break;
...
//                case 5:
////                    lift.setTrayPosition(0.2);
//                    drivetrain.autoMove(25.5, -44.9, 270, 0.5, 0.5, 2, odometryPose, telemetry);
//                    if (drivetrain.hasReached()) {
//                        main_id += 1;
//                    }
//                    break;
