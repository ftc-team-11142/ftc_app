...
@Disabled
@Config
@Autonomous(name = "!! Old CLOSE Blue Auto !!")
public class OldCloseBlueAuto extends LoggingOpMode {
...
//                        arm.setPosition(0);
                ...
                case 2:
                    ...
                    break;
                case 3:
                    drivetrain.autoMove(20, -20, 270, 1,1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached()) {
                        main_id += 1;
                        timer.reset();
                    }
                    break;
                case 4:
                    drivetrain.autoMove(27, -46.3, 270, 1,1, 2, odometryPose, telemetry);
                ...
                case 5:
                    if (timer.seconds() > 3) {
                        drivetrain.autoMove(27, -40, 270, 1,1, 2, odometryPose, telemetry);
                        if (drivetrain.hasReached()) {
                            main_id += 1;
                            timer.reset();
                        }
                    ...
                    break;
                case 6:
                    drivetrain.autoMove(46, -46, 270, 1,1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached() || timer.seconds() > 2.2) {
                        main_id += 1;
        ...
        if (result.equals("left")) {
            switch (main_id) {
                case 0:
                    drivetrain.autoMove(21.5, -16, 0, 1,1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached()) {
                        main_id += 1;
//                        arm.setPosition(0);
                    }
                    break;
                case 1:
                    drivetrain.autoMove(20, -14, 0, 1,1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached()) {
                        main_id += 1;
                        timer.reset();
                        pixel_dragger.setPosition(0.334);
                ...
                case 2:
                    ...
                    break;
                case 3:
                    drivetrain.autoMove(19.15, -20, 270, 1,1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached() || timer.seconds() > 1.3) {
                        main_id += 1;
                    }
                    break;
                case 4:
                    drivetrain.autoMove(19.15, -46.3, 270, 1,1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached()) {
                        main_id += 1;
                        pixel_dropper.setPosition(0.67);
                        timer.reset();
                ...
                case 5:
                    if (timer.seconds() > 3) {
                        drivetrain.autoMove(19.15, -40, 270, 1,1, 2, odometryPose, telemetry);
                        if (drivetrain.hasReached()) {
                            main_id += 1;
                            timer.reset();
                        }
...
//                        arm.setPosition(0);
                ...
                case 3:
                    ...
                    break;
                case 4:
                    drivetrain.autoMove(33, -20, 270, 1,1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached()) {
                        main_id += 1;
                        timer.reset();
                    }
                    break;
                case 5:
                    drivetrain.autoMove(33, -46.3, 270, 1,1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached() || timer.seconds() > 2.2) {
                        main_id += 1;
                        pixel_dropper.setPosition(0.67);
                        timer.reset();
                ...
                case 6:
                    if (timer.seconds() > 3) {
                        drivetrain.autoMove(33, -40, 270, 1,1, 2, odometryPose, telemetry);
                        if (drivetrain.hasReached()) {
                            main_id += 1;
                            timer.reset();
                        }
