...
//
    ...
    public void loop() {
        ...
        double testrot = rot;
        if (Math.abs(270 - testrot) > Math.abs(270 - (testrot-360))) {
            testrot -= 360;
        }

        testrot %= 360;

        double testodo = odometry_rotation;
        if (Math.abs(270 - testodo) > Math.abs(270 - (testodo-360))) {
            testodo -= 360;
        }
        ...
        telemetry.addData("testimu", testrot);
        telemetry.addData("testodo", testodo);
