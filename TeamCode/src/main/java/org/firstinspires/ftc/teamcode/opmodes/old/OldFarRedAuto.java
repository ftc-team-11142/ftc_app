...
@Disabled
@Config
@Autonomous(name = "!! Old FAR Red Auto !!")
public class OldFarRedAuto extends LoggingOpMode {
...
//                        arm.setPosition(0);
                ...
                case 1:
                    if (timer.seconds() > 0.7) {
                        ...
                        if (drivetrain.hasReached() || timer.seconds() > 0.8) {
                            main_id += 1;
                            timer.reset();
                        }
                    }
                ...
                case 2:
                    ...
                    break;
                case 3:
                    drivetrain.autoMove(48, -25, 0, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached() || timer.seconds() > 1.0) {
                        main_id += 1;
                        timer.reset();
                    }
                    break;
                case 4:
                    drivetrain.autoMove(48, -10, 90, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached() || timer.seconds() > 6.2) {
                        main_id += 1;
                    }
                    break;
                case 5:
                    drivetrain.autoMove(48, 71, 90, 1, 1, 2, odometryPose, telemetry);
                    ...
                    break;
                case 6:
                    drivetrain.autoMove(40, 82, 90, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached()) {
                        main_id += 1;
                        timer.reset();
                    }
                    break;
                case 7:
                    drivetrain.autoMove(25, 88.5, 90, 1, 1, 2, odometryPose, telemetry);
                ...
                case 8:
                    if (timer.seconds() > 3) {
                        drivetrain.autoMove(25, 82, 90, 1, 1, 2, odometryPose, telemetry);
                        if (drivetrain.hasReached()) {
                            main_id += 1;
                        }
                    }
                    break;
                case 9:
                    drivetrain.autoMove(49, 82, 90, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached() || timer.seconds() > 2.2) {
                        main_id += 1;
                        timer.reset();
                    }
                    break;
                case 10:
                    drivetrain.autoMove(49, 89, 90, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached()) {
                        main_id += 1;
        ...
        if (result.equals("left")) {
            switch (main_id) {
                case 0:
                    drivetrain.autoMove(21.5, -15, 0, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached()) {
                        main_id += 1;
                        timer.reset();
//                        arm.setPosition(0);
                    ...
                    break;
                case 1:
                    drivetrain.autoMove(19, -13, 0, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached() || timer.seconds() > 0.7) {
                        main_id += 1;
                        timer.reset();
                        pixel_dragger.setPosition(0.334);
                    }
                ...
                case 2:
                    if (timer.seconds() > 0.7) {
                        drivetrain.autoMove(19, -24.5, 0, 1, 1, 2, odometryPose, telemetry);
                ...
                case 5:
                    ...
                    break;
                case 6:
                    drivetrain.autoMove(31, 88.5, 90, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached() || timer.seconds() > 2.2) {
                        main_id += 1;
                        pixel_dropper.setPosition(0.7);
                        timer.reset();
                ...
                case 7:
                    if (timer.seconds() > 3) {
                        drivetrain.autoMove(31, 82, 90, 1, 1, 2, odometryPose, telemetry);
                        if (drivetrain.hasReached()) {
                            main_id += 1;
                            timer.reset();
                        }
                    ...
                    break;
                case 8:
                    drivetrain.autoMove(49, 83, 90, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached() || timer.seconds() > 2.2) {
                        main_id += 1;
                        pixel_dropper.setPosition(0.03);
                    }
...
//                        arm.setPosition(0);
                    ...
                    break;
                case 1:
                    drivetrain.autoMove(26, -9.784, 90, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached()) {
                        main_id += 1;
                    }
                    break;
                case 2:
                    drivetrain.autoMove(26, 3.8, 90, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached()) {
                        main_id += 1;
                        pixel_dragger.setPosition(0.334);
                        timer.reset();
                ...
                case 3:
                    if (timer.seconds() > 0.7) {
                        drivetrain.autoMove(26, -10, 90, 1, 1, 2, odometryPose, telemetry);
                        if (drivetrain.hasReached()) {
                            main_id += 1;
                            timer.reset();
                        }
                ...
                case 5:
                    ...
                    break;
                case 6:
                    drivetrain.autoMove(14.5, 88.5, 90, 1, 1, 2, odometryPose, telemetry);
                    if (drivetrain.hasReached() || timer.seconds() > 2.2) {
                        main_id += 1;
                        pixel_dropper.setPosition(0.7);
                        timer.reset();
                ...
                case 7:
                    if (timer.seconds() > 3) {
                        drivetrain.autoMove(14.5, 82, 90, 1, 1, 2, odometryPose, telemetry);
                        if (drivetrain.hasReached()) {
                            main_id += 1;
                            timer.reset();
                        }
