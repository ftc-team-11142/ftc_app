...
public class Odometry {
    ...
    public Odometry(MotorEx front_right, MotorEx back_right, MotorEx front_left, MotorEx back_left) {
        this.front_right = front_right;
        this.back_right = back_right;
        this.front_left = front_left;
        this.back_left = back_left;

        left_odometer = back_right.encoder.setDistancePerPulse(DISTANCE_PER_PULSE);
